...
public final class DeviceSimulatorLogic {
    ...
    public synchronized Message acceptCommand(String connectionId, Message command) {
        return commandRouter.handle(connectionId, command);
    }

    public synchronized Message pressPedestrian(String buttonId) {
    ...
    public synchronized Message vehicleDetected(String detectorId) {
    ...
    public synchronized Message vehicleCleared(String detectorId) {
        VehicleDetector detector = registry.get(detectorId, VehicleDetector.class);
    ...
    public synchronized Message setAuxiliaryStatus(String deviceId, String status) {
    ...
    public synchronized void failSafeAllRed() {
